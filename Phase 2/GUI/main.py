...
QUAD_SIZE = (int(100 * SCALE_FACTOR), int(100 * SCALE_FACTOR))
SEM_ERR_SIZE = (int(200 * SCALE_FACTOR), int(100 * SCALE_FACTOR))
SYNTAX_ERR_SIZE = (int(200 * SCALE_FACTOR), int(100 * SCALE_FACTOR))
SYMBOL_TABLE_SIZE = (int(600 * SCALE_FACTOR), int(200 * SCALE_FACTOR))
CODE_SIZE = (int(600 * SCALE_FACTOR), int(100 * SCALE_FACTOR))

# Calculate the new positions based on the scaling factor
QUAD_POS = (int(QUAD_POS[0] * SCALE_FACTOR), int(QUAD_POS[1] * SCALE_FACTOR))
SEM_ERR_POS = (int(SEM_ERR_POS[0] * SCALE_FACTOR), int(SEM_ERR_POS[1] * SCALE_FACTOR))
SYNTAX_ERR_POS = (int(SYNTAX_ERR_POS[0] * SCALE_FACTOR), int(SYNTAX_ERR_POS[1] * SCALE_FACTOR))
SYMBOL_TABLE_POS = (int(SYMBOL_TABLE_POS[0] * SCALE_FACTOR), int(SYMBOL_TABLE_POS[1] * SCALE_FACTOR))
CODE_POS = (int(CODE_POS[0] * SCALE_FACTOR), int(CODE_POS[1] * SCALE_FACTOR))
